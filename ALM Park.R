...
for(kk in 1:10){
  ...
  alm.RNAmf <- ALM_RNAmf(Xcand = x, fit.RNAmf, cost = cost, optim = TRUE, parallel = parallel, ncore=ncore)
  ...
  if (alm.RNAmf$chosen$level == 1) {
    fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf$fit1$X)*attr(fit.RNAmf$fit1$X,"scaled:scale")+attr(fit.RNAmf$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                      c(fit.RNAmf$fit1$y, apply(alm.RNAmf$chosen$Xnext,1,park91alc)),
    ...
    fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf$fit1$X)*attr(fit.RNAmf$fit1$X,"scaled:scale")+attr(fit.RNAmf$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                      ...
                                      c(fit.RNAmf$fit2$y, apply(alm.RNAmf$chosen$Xnext,1,park91a)),
                                      kernel="sqex", constant=TRUE)
  }
  ...
  while(park.cost[length(park.cost)] < 30){ # if total cost is less than the budget
    ...
    alm.RNAmf <- ALM_RNAmf(Xcand = x, fit.RNAmf.next, cost = cost, optim = TRUE, parallel = parallel, ncore = ncore)
    ...
    if (alm.RNAmf$chosen$level == 1) {
      fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf.next$fit1$X)*attr(fit.RNAmf.next$fit1$X,"scaled:scale")+attr(fit.RNAmf.next$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                        c(fit.RNAmf.next$fit1$y, apply(alm.RNAmf$chosen$Xnext,1,park91alc)),
      ...
      fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf.next$fit1$X)*attr(fit.RNAmf.next$fit1$X,"scaled:scale")+attr(fit.RNAmf.next$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                        ...
                                        c(fit.RNAmf.next$fit2$y, apply(alm.RNAmf$chosen$Xnext,1,park91a)),
                                        kernel="sqex", constant=TRUE)
    }
