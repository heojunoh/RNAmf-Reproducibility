...
for(kk in 1:10){
  ...
  if (alm.RNAmf$chosen$level == 1) {
    fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf$fit1$X)*attr(fit.RNAmf$fit1$X,"scaled:scale")+attr(fit.RNAmf$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                      c(fit.RNAmf$fit1$y, f1(alm.RNAmf$chosen$Xnext)),
    ...
    fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf$fit1$X)*attr(fit.RNAmf$fit1$X,"scaled:scale")+attr(fit.RNAmf$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                      c(fit.RNAmf$fit1$y, f1(alm.RNAmf$chosen$Xnext)),
                                      rbind(matrix(t(t(fit.RNAmf$fit2$X)*attr(fit.RNAmf$fit2$X,"scaled:scale")+attr(fit.RNAmf$fit2$X,"scaled:center"))[,1]), alm.RNAmf$chosen$Xnext),
                                      c(fit.RNAmf$fit2$y, f2(alm.RNAmf$chosen$Xnext)),
                                      kernel="sqex", constant=TRUE)
  }
  ...
  while(perd.cost[length(perd.cost)] < 50){ # if total cost is less than the budget
    ...
    if (alm.RNAmf$chosen$level == 1) {
      fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf.next$fit1$X)*attr(fit.RNAmf.next$fit1$X,"scaled:scale")+attr(fit.RNAmf.next$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                        c(fit.RNAmf.next$fit1$y, f1(alm.RNAmf$chosen$Xnext)),
      ...
      fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf.next$fit1$X)*attr(fit.RNAmf.next$fit1$X,"scaled:scale")+attr(fit.RNAmf.next$fit1$X,"scaled:center")), alm.RNAmf$chosen$Xnext),
                                        c(fit.RNAmf.next$fit1$y, f1(alm.RNAmf$chosen$Xnext)),
                                        rbind(matrix(t(t(fit.RNAmf.next$fit2$X)*attr(fit.RNAmf.next$fit2$X,"scaled:scale")+attr(fit.RNAmf.next$fit2$X,"scaled:center"))[,1]), alm.RNAmf$chosen$Xnext),
                                        c(fit.RNAmf.next$fit2$y, f2(alm.RNAmf$chosen$Xnext)),
                                        kernel="sqex", constant=TRUE)
    }
