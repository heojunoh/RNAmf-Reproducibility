...
for(kk in 1:10){
  ...
  almc.RNAmf <- ALMC_RNAmf(Xref = X.test, Xcand = X.test, fit.RNAmf, cost = cost,
  ...
  if (almc.RNAmf$chosen$level == 1) {
    fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf$fit1$X)*attr(fit.RNAmf$fit1$X,"scaled:scale")+attr(fit.RNAmf$fit1$X,"scaled:center")), almc.RNAmf$chosen$Xnext),
                                      c(fit.RNAmf$fit1$y, blade1(almc.RNAmf$chosen$Xnext)),
    ...
    fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf$fit1$X)*attr(fit.RNAmf$fit1$X,"scaled:scale")+attr(fit.RNAmf$fit1$X,"scaled:center")), almc.RNAmf$chosen$Xnext),
                                      c(fit.RNAmf$fit1$y, blade1(almc.RNAmf$chosen$Xnext)),
                                      rbind(t(t(fit.RNAmf$fit2$X)*attr(fit.RNAmf$fit2$X,"scaled:scale")+attr(fit.RNAmf$fit2$X,"scaled:center"))[,-ncol(fit.RNAmf$fit2$X)], almc.RNAmf$chosen$Xnext),
                                      c(fit.RNAmf$fit2$y, blade2(almc.RNAmf$chosen$Xnext)),
                                      kernel="sqex", constant=TRUE)
  }
  ...
  while(blade.cost[length(blade.cost)] < 45.5){ # if total cost is less than the budget
    ...
    almc.RNAmf <- ALMC_RNAmf(Xref = X.test, Xcand = X.test, fit.RNAmf.next, cost = cost,
                           optim = TRUE, parallel = parallel, ncore = ncore)
    ...
    if (almc.RNAmf$chosen$level == 1) {
      fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf.next$fit1$X)*attr(fit.RNAmf.next$fit1$X,"scaled:scale")+attr(fit.RNAmf.next$fit1$X,"scaled:center")), almc.RNAmf$chosen$Xnext),
                                        c(fit.RNAmf.next$fit1$y, blade1(almc.RNAmf$chosen$Xnext)),
      ...
      fit.RNAmf.next <- RNAmf_two_level(rbind(t(t(fit.RNAmf.next$fit1$X)*attr(fit.RNAmf.next$fit1$X,"scaled:scale")+attr(fit.RNAmf.next$fit1$X,"scaled:center")), almc.RNAmf$chosen$Xnext),
                                        c(fit.RNAmf.next$fit1$y, blade1(almc.RNAmf$chosen$Xnext)),
                                        rbind(t(t(fit.RNAmf.next$fit2$X)*attr(fit.RNAmf.next$fit2$X,"scaled:scale")+attr(fit.RNAmf.next$fit2$X,"scaled:center"))[,-ncol(fit.RNAmf$fit2$X)], almc.RNAmf$chosen$Xnext),
                                        c(fit.RNAmf.next$fit2$y, blade2(almc.RNAmf$chosen$Xnext)),
                                        kernel="sqex", constant=TRUE)
    }
  ...
  ### Save results ###
  costmatc3[[kk]] <- blade.cost
  rmsematc3[[kk]] <- blade.error
  crpsmatc3[[kk]] <- blade.crps
  
  time.each3[kk] <- proc.time()[3]- time.start
  # save.image("Blade ALMC.RData")
}
costmatc3
rmsematc3
crpsmatc3
