...
Note that you may need to activate a few lines on ALM_two_level, ALC_two_level, and ALMC_two_level for active learning.
...
This is reproducing plots of RMSE for synthetic functions. Each script will run the simulation for the corresponding synthetic function. Python codes may take long.
...
This is reproducing plots of Computation time (sec.) for synthetic functions. 
...
This is reproducing plots of RMSE and CRPS for active learning on Perdikaris function.
```{r fig.align = 'center', fig.width=10, fig.height=5}
...
This is reproducing plots of final RMSE and proportion of low-fidelity data for active learning on Perdikaris function.
```{r fig.align = 'center', fig.width=10, fig.height=5}
# Final result
...
This is reproducing plots of RMSE and CRPS for active learning on Park function.
...
This is reproducing plots of final RMSE and proportion of low-fidelity data for active learning on Park function.
```{r fig.align = 'center', fig.width=10, fig.height=5}
# Final result
Strategy <- c(rep("ALM",10),rep("ALC",10),rep("ALMC",10),rep("Cokriging-CV",10),rep("MR-SUR",10))
Strategy <- factor(Strategy, levels=c("ALM", "ALC", "ALMC", "Cokriging-CV", "MR-SUR"))
...
This is reproducing plots of RMSE and CRPS for Thermal Stress Analysis of Jet Engine Turbine Blade data. This includes matlab and python codes. Before you run, you should set the path on R, matlab, and python script.
```{r fig.align = 'center', fig.width=10, fig.height=5}
...
This is reproducing plots of RMSE and CRPS for active learning on Blade data. Before you run, you should set the path on R and matlab script.
...
##### Section 6: Reproducing Figure 13
This is reproducing plots of final RMSE and proportion of low-fidelity data for active learning on Blade data.
```{r fig.align = 'center', fig.width=9, fig.height=3}
# Final result
Strategy <- c(rep("ALM",10),rep("ALC",10),rep("ALMC",10),rep("Cokriging-CV",10),rep("MR-SUR",10))
Strategy <- factor(Strategy, levels=c("ALM", "ALC", "ALMC", "Cokriging-CV", "MR-SUR"))
